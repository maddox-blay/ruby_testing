...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      subject(:mean_test_1) {described_class.new(5, 9, number_guessing).make_guess}
      it 'returns 7' do
    ...
    context 'when min is 8 and max is 9' do
      subject(:mean_test_2) {described_class.new(8, 9, number_guessing).make_guess}
      it 'returns 8' do
    ...
    context 'when min is 0 and max is 3' do
      subject(:mean_test_3) {described_class.new(0, 3, number_guessing).make_guess}
      it 'returns 1' do
    ...
    context 'when min and max both equal 3' do
      subject(:mean_test_4) {described_class.new(3, 3, number_guessing).make_guess}
      it 'returns 3' do
  ...
  describe '#game_over?' do
    let(:game_over_guess) {double('game_over_guess', value: 8)}
    context 'when guess and random_number are equal' do
      ...
      subject(:game_over_test) {described_class.new(0, 9, game_over_guess, 8)}
    ...
    context 'when guess and random_number are not equal' do
      subject(:game_over_test2) {described_class.new(0, 9, game_over_guess, 9)}
  ...
  describe '#update_range' do
    ...
    context 'when the guess is 7, min=5, and max=8' do
      subject(:finale) {described_class.new(5, 8, number_range, 7)}
      it 'updates min to the same value as max' do
        subject.update_range
        expect(subject.min).to eq 8
      end
